...
FIDELITY_MAP = {
    ...
    "rStyle": {"status": "pending", "detail": "Word character style not yet lowered to strict LaTeX"},
    "color": {"status": "pending", "detail": "visual formatting not yet exported to LaTeX"},
