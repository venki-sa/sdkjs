...
(function (window) {
	...
	function CreateLaTeXExportValidation()
	{
		return {
			unknownNodes: [],
			unknownSymbols: [],
	...
	function CreateLaTeXExportContext(options)
	{
		...
		return {
			...
			fontMode: options && options.fontMode ? options.fontMode : "",
			isDefaultText: !!(options && options.isDefaultText),
		};
	}

	AscMath.CreateLaTeXExportValidation = CreateLaTeXExportValidation;
	AscMath.CreateLaTeXExportContext = CreateLaTeXExportContext;
})(window);
